    ...
    void display_Sale()
{
    ...
    for(int i=0;i<6;i++)
    {
        for(int j=0;j<12;j++)
        {
            System.out.print(sales[i][j] + "\t"); // Use print instead of println for tab separation
        }
    ...
    void avg_sales(){
        ...
        for(int i=0;i<6;i++){
            ...
            System.out.println("Average sale for manufacturer " + i + " is: " + (total / 12.0)); // Use 12.0 for floating-point division
        }
    }
